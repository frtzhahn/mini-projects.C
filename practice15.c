...
//notes for me
//learn how to use the library of string.h
//practice the syntaxes since it is a powerful librabry for string based conditional statements
//learn the difference when to use fgets and scanf
//explore the input buffers more
